...
var colorsArray = ['rgb(12, 172, 212)', 'white', 'red', 'blue', 'url(https://images.unsplash.com/photo-1583511655857-d19b40a7a54e)']
var num = 0
...
imageContainer.addEventListener("click", function(event) {
  ...
  function changeColor(event) {
    event.currentTarget.setAttribute(
        "style",
        "background:"+colorsArray[num]+"; background-size: 100vw 100vh;",
    );
    if(num >= 4){
  ...
  BODZ.addEventListener("click", changeColor)
